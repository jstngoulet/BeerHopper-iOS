...
- **Dependency injection by default:** inject API clients, repositories, stores, secure adapters, analytics, realtime clients, clocks, and feature flags wherever practical instead of reaching through globals.
